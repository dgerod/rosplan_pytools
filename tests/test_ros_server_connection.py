...
class TestRosServerConnection(unittest.TestCase):
    ...
    @mock.patch('rosplan_pytools.controller.scene_database.rospy.get_param')
    @mock.patch('rosplan_pytools.controller.scene_database.rospy.set_param')
    def test_register_new_element_in_empty_db(self, mock_set_param, mock_get_param, mock_has_param):
        ...
        self.assertTrue(ros_server.add_element("element_1", pose))
        ...
        element = {'msg_type': pose._type,
                   ...
                   'id': 123456789}
        mock_get_param.side_effect = [1, "element_1", element]

        success, info = ros_server.get_element("element_1")
    ...
    @mock.patch('rosplan_pytools.controller.scene_database.rospy.get_param')
    @mock.patch('rosplan_pytools.controller.scene_database.rospy.set_param')
    def test_register_new_element_in_non_empty_db(self, mock_set_param, mock_get_param, mock_has_param):
        ...
        mock_has_param.side_effect = [False]
        mock_set_param.side_effect = [True, True, True]
        mock_get_param.side_effect = [1, "other_element", 1]
    ...
    @mock.patch('rosplan_pytools.controller.scene_database.rospy.get_param')
    @mock.patch('rosplan_pytools.controller.scene_database.rospy.set_param')
    def test_register_existing_element(self, mock_set_param, mock_get_param, mock_has_param):
        ...
        mock_has_param.side_effect = [False]
        mock_set_param.side_effect = [True, True, True]
        mock_get_param.side_effect = [1, "element_1"]

        self.assertFalse(ros_server.add_element("element_1", Pose()))
...
class TestRosServerConnectionWithRealRosServer(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertTrue(ros_server.add_element("element_2", Pose()))
        self.assertEqual(ros_server.num_elements(), 2)

        self.assertTrue(ros_server.add_element("element_3", Empty()))
        self.assertEqual(ros_server.num_elements(), 3)

        success, info = ros_server.get_element("element_1")
        success, info = ros_server.get_element("element_2")
        success, info = ros_server.get_element("element_3")

        self.assertTrue(ros_server.remove_element("element_1"))
        self.assertEqual(ros_server.num_elements(), 2)

        self.assertTrue(ros_server.remove_element("element_2"))
        self.assertEqual(ros_server.num_elements(), 1)

        self.assertTrue(ros_server.remove_element("element_3"))
        self.assertEqual(ros_server.num_elements(), 0)
