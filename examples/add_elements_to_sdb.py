...
def main():
    ...
    input("Add elements. Press Enter to continue...")
    ...
    input("Add existing element. Press Enter to continue...")
    ...
    input("Remove element. Press Enter to continue...")
    ...
    input("Get an element. Press Enter to continue...")

    success, element = sdb.get_element("element_3")
    print("element: ", element)
    print("num elements: ", sdb.num_elements())

    input("Remove all element. Press Enter to continue...")
